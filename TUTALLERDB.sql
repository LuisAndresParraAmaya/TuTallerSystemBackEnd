...
CREATE TABLE IF NOT EXISTS `tutaller`.`workshop_office` (
  ...
  `workshop_suscription_id` INT NOT NULL,
  `workshop_office_address` VARCHAR(45) NOT NULL,
  `workshop_office_phone` INT NOT NULL,
  PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
-- Table `tutaller`.`employee`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tutaller`.`employee` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `workshop_office_id` SMALLINT NOT NULL,
  `user_rut` INT NOT NULL,
  `employee_specialization` VARCHAR(45) NOT NULL,
  `employee_experience` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `tutaller`.`workshop_ad` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `workshop_office_id` SMALLINT NOT NULL,
  `workshop_ad_bid` VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tutaller`.`workshop_office_service` (
  ...
  `workshop_office_service_price` INT NOT NULL,
  `workshop_office_service_estimated_time` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tutaller`.`workshop_office_work` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `workshop_office_service_id` INT NOT NULL,
  `employee_id` INT NOT NULL,
  `user_user_rut` INT NOT NULL,
  ...
  CONSTRAINT `fk_workshop_office_work_employee1`
    ...
    REFERENCES `tutaller`.`employee` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `tutaller`.`workshop_office_service_advance` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `image_id` INT NOT NULL,
  `workshop_office_work_id` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tutaller`.`payment_receipt` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `user_rut` INT NOT NULL,
  `payment_receipt_date` VARCHAR(45) NOT NULL,
  `payment_receipt_time` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `tutaller`.`postulation` (
  ...
  `postulation_description` VARCHAR(99) NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_postulations_user1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_postulations_workshop_office1`
    FOREIGN KEY (`workshop_office_id`)
    REFERENCES `tutaller`.`workshop_office` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `tutaller`.`questionnaire_question` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `usability_questionnaire_id` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tutaller`.`office_work_technical_report` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `workshop_office_work_id` INT NOT NULL,
  `office_work_technical_report_km` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `tutaller`.`workshop_office_attention_time`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tutaller`.`workshop_office_attention_time` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `workshop_office_id` SMALLINT NOT NULL,
  `workshop_office_attention_date` DATE NOT NULL,
  `workshop_office_attention_time` TIME NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `tutaller`.`workshop_office_work_case` (
  `idworkshop_office_work_case` INT NOT NULL,
...
INSERT INTO 
	user_type(user_type_name, user_type_description)
VALUES
	('admin','system administrator'),
	('user','system user'),
  ('adminworkshop','workshop administrator'),
  ('technicianworkshop','workshop office technician')
